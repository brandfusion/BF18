...
document.querySelectorAll("#ourteam .image").forEach(anchor => {
  anchor.addEventListener('click', function(e) {     
    if (e.currentTarget.querySelector("ul").children[0].classList.contains("hidden")) {
      e.currentTarget.querySelector("ul").children[1].classList.add("hidden");
      e.currentTarget.querySelector("ul").children[0].classList.remove("hidden");
    } else {
      e.currentTarget.querySelector("ul").children[0].classList.add("hidden");
      e.currentTarget.querySelector("ul").children[1].classList.remove("hidden");
    }
  })
});
